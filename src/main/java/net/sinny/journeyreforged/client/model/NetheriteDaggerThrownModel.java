...
public class NetheriteDaggerThrownModel extends EntityModel<ThrownDaggerEntity> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of("journey-reforged", "netherite_dagger_thrown"), "main");
