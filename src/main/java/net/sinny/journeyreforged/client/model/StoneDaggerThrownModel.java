...
public class StoneDaggerThrownModel extends EntityModel<ThrownDaggerEntity> {
    // This part is perfect. It defines a unique ID for your model's shape.
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of("journey-reforged", "stone_dagger_thrown"), "main");
