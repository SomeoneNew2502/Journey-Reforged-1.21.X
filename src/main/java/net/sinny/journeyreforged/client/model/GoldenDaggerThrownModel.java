...
public class GoldenDaggerThrownModel extends EntityModel<ThrownDaggerEntity> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of("journey-reforged", "golden_dagger_thrown"), "main");
